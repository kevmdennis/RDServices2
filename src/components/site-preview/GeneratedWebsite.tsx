...
import TrackingDebugPanel from "@/components/site-preview/TrackingDebugPanel";
...
export type GeneratedWebsiteProps = {
  site: Site;
  business: Business;
...
export default function GeneratedWebsite({
  ...
  const phoneHref = contact.phone
    ...
    : null;
  const trackSiteId = trackingEnabled ? site.id : undefined;
  const trackBusinessId = trackingEnabled ? business.id : undefined;
    ...
    >
      {trackingEnabled && (
        <SitePageViewTracker
          ...
          eventValue={pageViewEventValue}
        />
      )}
      {debugTracking && trackingEnabled && (
        <TrackingDebugPanel siteId={site.id} businessId={business.id} />
      )}
      ...
      >
        ...
        <p className="mt-4 text-white/70">
          {isPublicView
            ...
            : "Website preview generated from Google business data."}
        </p>
      </footer>
    </div>
  );
